  ...
  return (
    <section className="py-20 md:py-25" ref={sectionRef}>
      <div className="w-[90%] m-auto md:container">
        ...
        >
          <div
            className="absolute inset-0 bg-[rgba(55,25,226,0.3)] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_50%_35%,black,transparent)] group-hover:opacity-0 transition duration-1000"
            style={{
          ...
          <motion.div
            className="absolute inset-0 bg-[rgba(25,72,226,0.3)] bg-blend-overlay group-hover:opacity-100 opacity-0 transition duration-1000"
            style={{
              maskImage,
              backgroundImage: `url(${gridLines.src})`,
            }}
