    ...
    >
      {props.selected && (
        <motion.div
          ...
          className="absolute border border-[#23007a] inset-0 -m-px rounded-full"
        ></motion.div>
      )}
      ...
      <div className="flex items-center gap-2  ">
        ...
        <h3
          className={`text-sm  font-tomorrow ${
            props.selected ? "text-purple-600 font-medium" : "text-white font-light" 
          }`}
        >
          {props.title}
        </h3>
    ...
    <button className="relative px-6 py-3 bg-violet-600 text-white rounded-lg hover:animate-sparkle transition duration-300 overflow-hidden">
      ...
      <div className="w-[90%] m-auto md:container py-20 md:py-25 ">
        <GlobalHeading
          ...
          subTitle="We keep adding unique projects every week"
        />
