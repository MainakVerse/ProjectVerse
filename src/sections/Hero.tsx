...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute w-full h-full -mb-72 -translate-x-1/2 -translate-y-1/2 rounded-full md:-md-190 md:-bottom-2/3 -bottom-1/2 left-1/2">
...
const colors = ["#6666ff", "#3366ff", "#3333ff"];
const sampleArcs = [
  {
    order: 1,
    startLat: -19.885592,
